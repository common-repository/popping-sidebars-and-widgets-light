...
$otw_sbm_widget_settings = array( 
	'before_widget' => array( esc_html__( 'HTML to be placed before every widget.', 'otw_pswl' ), '<div id="%1$s" class="widget %2$s">' ),
	'after_widget' => array( esc_html__( 'HTML to be placed after every widget.', 'otw_pswl' ), '</div>' ),
	'before_title' =>array( esc_html__( 'HTML to be placed before every widget title.', 'otw_pswl' ), ' <h3 class="widgettitle">' ),
	'after_title' =>array(  esc_html__( 'HTML to be placed after every widget title.', 'otw_pswl' ), '</h3>' )
);
